INSERT INTO poet (name, bio, time_birth, time_death)
VALUES (
    'Анна Ахматова',
...
INSERT INTO event (name, coord_x, coord_y, photo, description, time_start, time_end, poet_id)
VALUES (
    ...
    1889,
    1889,
    (SELECT id FROM poet WHERE name = 'Анна Ахматова')
);

INSERT INTO event (name, coord_x, coord_y, description, time_start, time_end, poet_id)
VALUES (
...
INSERT INTO work (name, description, link, poet_id)
VALUES (
...
INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'Реквием'),
    (SELECT id FROM event WHERE name = 'Дом Ардовых на Большой Ордынке')
);

INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'Поэма без героя'),
    (SELECT id FROM event WHERE name = 'Дача в Комарово')
);
...
VALUES
    (
        ...
        1867,
        1867,
        (SELECT id FROM poet WHERE name = 'Константин Дмитриевич Бальмонт')
    ),
    (
...
INSERT INTO event (name, description, time_start, time_end, coord_x, coord_y, poet_id)
VALUES
    (
...
VALUES
    ...
    (
        (SELECT id FROM work WHERE name = 'В безбрежности'),
        (SELECT id FROM event WHERE name = 'Таруса')
    ),
    (
        (SELECT id FROM work WHERE name = 'Тишина'),
        (SELECT id FROM event WHERE name = 'Териоки (Зеленогорск)')
    );
...
VALUES (
    ...
    1880,
    1880,
    (SELECT id FROM poet WHERE name = 'Андрей Белый (Борис Бугаев)')
);
...
INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'Золото в лазури'),
    (SELECT id FROM event WHERE name = 'Дом на Арбате')
);
...
INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'Петербург'),
    (SELECT id FROM event WHERE name = 'Кучинский посёлок')
);
...
VALUES (
    ...
    1880,
    1880,
    (SELECT id FROM poet WHERE name = 'Александр Блок')
);
...
INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'Письма с военной службы'),
    (SELECT id FROM event WHERE name = 'Служба в инженерных войсках в Белоруссии')
);
...
VALUES (
    ...
    1891,
    1891,
    (SELECT id FROM poet WHERE name = 'Михаил Булгаков')
);
...
INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'Белая гвардия'),
    (SELECT id FROM event WHERE name = 'Дом Турбиных в Киеве')
);
...
INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'Собачье сердце'),
    (SELECT id FROM event WHERE name = 'Квартира на Большой Садовой')
);

INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'Мастер и Маргарита'),
    (SELECT id FROM event WHERE name = 'Дача в Зубово')
);
...
VALUES
    (
        ...
        1868,
        1868,
        (SELECT id FROM poet WHERE name = 'Максим Горький (Алексей Максимович Пешков)')
    ),
    (
        'Место смерти: Москва',
        55.7558,
...
VALUES
    (
        (SELECT id FROM work WHERE name = 'Макар Чудра'),
        (SELECT id FROM event WHERE name = 'Литературный дебют: "Макар Чудра"')
    ),
    (
        (SELECT id FROM work WHERE name = 'Очерки и рассказы'),
        (SELECT id FROM event WHERE name = 'Публикация "Очерков и рассказов"')
    ),
    (
        (SELECT id FROM work WHERE name = 'Мещане'),
        (SELECT id FROM event WHERE name = 'Премьера пьесы "Мещане"')
    ),
    (
        (SELECT id FROM work WHERE name = 'На дне'),
        (SELECT id FROM event WHERE name = 'Гаспра, Крым')
    ),
    (
        (SELECT id FROM work WHERE name = 'Детство'),
        (SELECT id FROM event WHERE name = 'Капри, Италия')
    );
...
VALUES (
    ...
    1886,
    1886,
    (SELECT id FROM poet WHERE name = 'Николай Гумилёв')
);
...
INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'Я в лес бежал из городов'),
    (SELECT id FROM event WHERE name = 'Годы в Тифлисе')
);

INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'Жираф'),
    (SELECT id FROM event WHERE name = 'Первое африканское путешествие')
);

INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'Колчан'),
    (SELECT id FROM event WHERE name = 'Военная служба в уланском полку')
);

INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'Огненный столп'),
    (SELECT id FROM event WHERE name = 'Последние годы в Петрограде')
);
...
VALUES (
    ...
    1895,
    1895,
    (SELECT id FROM poet WHERE name = 'Сергей Есенин')
);
...
INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'Радуница'),
    (SELECT id FROM event WHERE name = 'Детство в Константиново')
);

INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'Пугачёв'),
    (SELECT id FROM event WHERE name = 'Путешествие по Средней Азии')
);

INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'Персидские мотивы'),
    (SELECT id FROM event WHERE name = 'Поездка в Закавказье')
);

INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'Отговорила роща золотая'),
    (SELECT id FROM event WHERE name = 'Детство в Константиново')
);
...
VALUES
    (
        ...
        1870,
        1870,
        (SELECT id FROM poet WHERE name = 'Александр Иванович Куприн')
    ),
    (
...
VALUES
    (
        (SELECT id FROM work WHERE name = 'Последний дебют'),
        (SELECT id FROM event WHERE name = 'Литературный дебют: "Последний дебют"')
    ),
    (
        (SELECT id FROM work WHERE name = 'Кадеты'),
        (SELECT id FROM event WHERE name = 'Обучение в Александровском военном училище')
    ),
    (
        (SELECT id FROM work WHERE name = 'Молох'),
        (SELECT id FROM event WHERE name = 'Санкт-Петербург')
    ),
    (
        (SELECT id FROM work WHERE name = 'Олеся'),
        (SELECT id FROM event WHERE name = 'Санкт-Петербург')
    ),
    (
        (SELECT id FROM work WHERE name = 'Поединок'),
        (SELECT id FROM event WHERE name = 'Глебово-Вишняки')
    );
...
VALUES (
    ...
    1891,
    1891,
    (SELECT id FROM poet WHERE name = 'Осип Мандельштам')
);

INSERT INTO event (name, coord_x, coord_y, description, time_start, time_end, poet_id)
VALUES (
    'Место смерти - Владперпункт',
    43.116667, 131.900000,
...
INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'Камень'),
    (SELECT id FROM event WHERE name = 'Дом Мурузи')
);

INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'Воронежские тетради'),
    (SELECT id FROM event WHERE name = 'Воронежская ссылка')
);

INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'Армения'),
    (SELECT id FROM event WHERE name = 'Поездка в Армению')
);

INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'Мы живём, под собою не чуя страны...'),
    (SELECT id FROM event WHERE name = 'Московский период')
);
...
VALUES (
    ...
    1893,
    1893,
    (SELECT id FROM poet WHERE name = 'Владимир Маяковский')
);
...
INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'Первые стихи (1909)'),
    (SELECT id FROM event WHERE name = 'Заключение в Бутырской тюрьме')
);

INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'Владимир Маяковский'),
    (SELECT id FROM event WHERE name = 'Футуристический период в Петербурге')
);

INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'Необычайное приключение, бывшее с Владимиром Маяковским летом на даче'),
    (SELECT id FROM event WHERE name = 'Дача в Пушкино')
);

INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'Моё открытие Америки'),
    (SELECT id FROM event WHERE name = 'Поездка в Америку')
);
...
VALUES
    (
        ...
        1890,
        1890,
        (SELECT id FROM poet WHERE name = 'Борис Леонидович Пастернак')
    ),
    (
...
VALUES
    (
        (SELECT id FROM work WHERE name = 'Близнец в тучах'),
        (SELECT id FROM event WHERE name = 'Литературный дебют: "Близнец в тучах"')
    ),
    (
        (SELECT id FROM work WHERE name = 'Сестра моя — жизнь'),
        (SELECT id FROM event WHERE name = 'Публикация "Сестра моя — жизнь"')
    ),
    (
        (SELECT id FROM work WHERE name = 'Доктор Живаго'),
        (SELECT id FROM event WHERE name = 'Переделкино')
    ),
    (
        (SELECT id FROM work WHERE name = 'Доктор Живаго'),
        (SELECT id FROM event WHERE name = 'Начало работы над "Доктором Живаго"')
    ),
    (
        (SELECT id FROM work WHERE name = 'Доктор Живаго'),
        (SELECT id FROM event WHERE name = 'Публикация "Доктора Живаго"')
    );
...
VALUES
    (
        ...
        1883,
        1883,
        (SELECT id FROM poet WHERE name = 'Алексей Николаевич Толстой')
    ),
    (
        'Место смерти: Москва',
        55.7558,
...
VALUES
    (
        (SELECT id FROM work WHERE name = 'Детство Никиты'),
        (SELECT id FROM event WHERE name = 'Никольское')
    ),
    (
        (SELECT id FROM work WHERE name = 'Хождение по мукам'),
        (SELECT id FROM event WHERE name = 'Начало работы над "Хождением по мукам"')
    ),
    (
        (SELECT id FROM work WHERE name = 'Пётр Первый'),
        (SELECT id FROM event WHERE name = 'Работа над "Петром Первым"')
    ),
    (
        (SELECT id FROM work WHERE name = 'Аэлита'),
        (SELECT id FROM event WHERE name = 'Берлин')
    ),
    (
        (SELECT id FROM work WHERE name = 'Иван Грозный'),
        (SELECT id FROM event WHERE name = 'Военные публикации')
    );
...
VALUES (
    ...
    1892,
    1892,
    (SELECT id FROM poet WHERE name = 'Марина Цветаева')
);
...
INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'Вечерний альбом'),
    (SELECT id FROM event WHERE name = 'Дом в Борисоглебском переулке')
);

INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'Поэма горы'),
    (SELECT id FROM event WHERE name = 'Чешский период')
);

INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'После России'),
    (SELECT id FROM event WHERE name = 'Парижский период')
);

INSERT INTO work_event (work_id, event_id)
VALUES (
    (SELECT id FROM work WHERE name = 'Крысолов'),
    (SELECT id FROM event WHERE name = 'Чешский период')
);
...
VALUES
    (
        ...
        1860,
        1860,
        (SELECT id FROM poet WHERE name = 'Антон Павлович Чехов')
    ),
    (
...
VALUES
    (
        (SELECT id FROM work WHERE name = 'Письмо учёному соседу'),
        (SELECT id FROM event WHERE name = 'Литературный дебют: "Письмо учёному соседу"')
    ),
    (
        (SELECT id FROM work WHERE name = 'Остров Сахалин'),
        (SELECT id FROM event WHERE name = 'Поездка на Сахалин')
    ),
    (
        (SELECT id FROM work WHERE name = 'Чайка'),
        (SELECT id FROM event WHERE name = 'Мелихово')
    ),
    (
        (SELECT id FROM work WHERE name = 'Дядя Ваня'),
        (SELECT id FROM event WHERE name = 'Мелихово')
    ),
    (
        (SELECT id FROM work WHERE name = 'Палата №6'),
        (SELECT id FROM event WHERE name = 'Мелихово')
    ),
    (
        (SELECT id FROM work WHERE name = 'Вишнёвый сад'),
        (SELECT id FROM event WHERE name = 'Ялта')
    ),
    (
        (SELECT id FROM work WHERE name = 'Три сестры'),
        (SELECT id FROM event WHERE name = 'Ялта')
    );
